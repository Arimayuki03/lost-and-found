...
CREATE TABLE `chat_message`  (
  ...
  KEY `idx_chat_receiver_read` (`receiver_id`, `is_read`) USING BTREE,
  KEY `idx_chat_pair_time` (`sender_id`, `receiver_id`, `timestamp`) USING BTREE,
...
CREATE TABLE `found_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_found_item_category` (`category`) USING BTREE,
  KEY `idx_found_item_under_review` (`is_under_review`) USING BTREE,
  KEY `idx_found_item_review_created` (`is_under_review`, `created_at`) USING BTREE,
...
CREATE TABLE `lost_item` (
  ...
  KEY `idx_lost_item_under_review` (`is_under_review`) USING BTREE,
  KEY `idx_lost_item_review_created` (`is_under_review`, `created_at`) USING BTREE,
